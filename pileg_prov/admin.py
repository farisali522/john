...
class DapilAdmin(ImportExportModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        return qs.prefetch_related('kokab__kecamatan_set__rekap_suara_prov__detail_suara')
    ...
    def get_suara_partai_dict(self, dapil_obj):
        ...
        for kokab in dapil_obj.kokab.all():
            for kec in kokab.kecamatan_set.all():
                if hasattr(kec, 'rekap_suara_prov'):
                    for detail in kec.rekap_suara_prov.detail_suara.all():
    ...
    def get_global_kursi_partai(self):
        ...
        from master.sainte_lague import hitung_sainte_lague
        global_kursi = {}
        for dapil in Dapil.objects.prefetch_related('kokab__kecamatan_set__rekap_suara_prov__detail_suara'):
